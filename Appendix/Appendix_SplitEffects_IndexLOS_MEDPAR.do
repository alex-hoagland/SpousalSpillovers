...
gcollapse (max) snf treated* los_*, by(index_id hhid eventid ym tt reltime_months ) fast
...
graph save "${hoaglandoutput}/SplitEffects_IndexLOS_snf_$today.gph", replace
graph export "${hoaglandoutput}/SplitEffects_IndexLOS_snf_$today.png", as(png) replace
graph export "${hoaglandoutput}/SplitEffects_IndexLOS_snf_$today.pdf", as(pdf) replace
********************************************************************************
