...
graph save "${hoaglandoutput}/EventStudy_snf-extraevents_$today.gph", replace
graph export "${hoaglandoutput}/EventStudy_snf-extraevents_$today.png", as(png) replace
graph export "${hoaglandoutput}/EventStudy_snf-extraevents_$today.pdf", as(pdf) replace
********************************************************************************
