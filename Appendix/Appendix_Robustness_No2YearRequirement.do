...
compress
save "${input_datapath}/weekpanel_no2y.dta", replace 
...
graph save "${hoaglandoutput}/EventStudy_`1'-no2y_$today.gph", replace
graph export "${hoaglandoutput}/EventStudy_`1'-no2y_$today.png", as(png) replace
graph export "${hoaglandoutput}/EventStudy_`1'-no2y_$today.pdf", as(pdf) replace
********************************************************************************
